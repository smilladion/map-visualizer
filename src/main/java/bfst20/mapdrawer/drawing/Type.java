...
public enum Type {
    ...
    FOREST("landuse", "forest", Color.LIGHTGREEN, Color.GREY, true, 0, 6000),
    ...
    // roads
    HIGHWAY("highway", "highway", Color.GAINSBORO, Color.GAINSBORO, false, 1, 80000),
    MOTORWAY("highway", "motorway", Color.SALMON, Color.BLACK, false, 4, 1000),
    MOTORWAY_LINK("highway", "motorway_link", Color.SALMON, Color.BLACK, false, 4, 1000),
    PRIMARY("highway", "primary", Color.LIGHTPINK, Color.BLACK, false, 4, 1000),
    PRIMARY_LINK("highway", "primary_link", Color.LIGHTPINK, Color.BLACK, false, 4, 1000),
    SECONDARY("highway", "secondary", Color.BISQUE, Color.BLACK, false, 4, 1000),
    SECONDAY_LINK("highway", "seconday", Color.BISQUE, Color.BLACK, false, 3, 1000),
    TERTIARY("highway", "tertiary", Color.GAINSBORO, Color.GAINSBORO, false, 4, 6000),
    TERTIARY_LINK("highway", "tertiary_link", Color.GAINSBORO, Color.GAINSBORO, false, 3, 6000),
    UNCLASSIFIED("highway", "unclassified", Color.GAINSBORO, Color.GAINSBORO, false, 3, 10000),
    RESIDENTIAL_ROAD("highway", "residential", Color.GAINSBORO, Color.GAINSBORO, false, 2, 18000),
    LIVING_STREET("highway", "living_street", Color.GAINSBORO, Color.GAINSBORO, false, 2, 30000),
    SERVICE("highway", "service", Color.GAINSBORO, Color.GAINSBORO, false, 1, 80000),
    PEDESTRIAN("highway", "pedestrian", Color.GAINSBORO, Color.GAINSBORO, false, 1, 80000),
    TRACK("highway", "track", Color.GAINSBORO, Color.GAINSBORO, false, 1, 80000),

    SEARCHRESULT("highway", "searchresult", Color.RED, Color.RED, false, 3, 1000),
    BUILDING("building", "building", Color.DARKGREY, Color.DARKGREY, true, 0, 80000),
