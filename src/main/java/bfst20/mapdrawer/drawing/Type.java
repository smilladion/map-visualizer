...
public enum Type {
    ...
    ALLOTMENTS("allotments", Color.LIGHTGREEN, true, 0, 0),
    WETLAND("wetland", Color.CADETBLUE, true, 0, 0),
    //GRASS("grass", Color.LAWNGREEN, true, 0, 0),
    FARMLAND("farmland", Color.LIGHTGOLDENRODYELLOW, true, 0, 0),
    BROWNFIELD("brownfield", Color.DARKKHAKI, true, 0, 0),
    LANDFILL("landfill", Color.DARKKHAKI, true, 0, 0),
    GRASSLAND("grassland", Color.LAWNGREEN, true, 0, 0),
    FOREST("forest", Color.FORESTGREEN, true, 0, 0),
    HEATH("heath", Color.WHEAT, true, 0, 0),
    MEADOW("meadow", Color.LIGHTGREEN, true, 0, 0),
    QUARRY("quarry", Color.LIGHTGREY, true, 0, 0),
    WOOD("wood", Color.FORESTGREEN, true, 0, 0), 
    CEMETERY("cemetery", Color.LIGHTGREEN, true, 0, 0),
    ORCHARD("orchard", Color.GREEN, true, 0, 0),
    FARMYARD("farmyard", Color.DARKSALMON, true, 0, 0),
    AERODROME("aerodrome", Color.LIGHTGREY, true, 0, 0),
    APRON("apron", Color.GREY, true, 0, 0),
    RUNWAY("runway", Color.DARKGREY, true, 2, 0),
    BASIN("basin", Color.LIGHTBLUE, true, 0, 0),
    RESERVOIR("reservoir", Color.LIGHTBLUE, true, 0, 0),
    PARKING("parking", Color.LIGHTGREY, true, 0, 0),
    VILLAGE_GREEN("village_green", Color.LIGHTGREEN, true, 0, 0),
    SCRUB("scrub", Color.DARKOLIVEGREEN, true, 0, 0),
    BEACH("beach", Color.YELLOW, true, 0, 0),
    WATER("water", Color.LIGHTBLUE, true, 0, 0),
    STREAM("stream", Color.LIGHTBLUE, false, 2, 0),
    PIER("pier", Color.LIGHTGREY, false, 2, 0),
