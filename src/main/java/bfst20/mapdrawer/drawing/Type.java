...
public enum Type {
    ...
    WETLAND("natural", "wetland", Color.DARKSEAGREEN, true, 0, 18000),
    ...
    RUNWAY("aeroway", "runway", Color.DARKGREY, true, 2, 18000),
    ...
    SERVICE("highway", "service", Color.GAINSBORO, false, 1, 80000),
    PEDESTRIAN("highway", "pedestrian", Color.GAINSBORO, false, 1, 80000),
    TRACK("highway", "track", Color.GAINSBORO, false, 1, 80000),

    SEARCHRESULT("highway", "searchresult", Color.RED, false, 3, 1000),
    BUILDING("building", "building", Color.DARKGREY, true, 0, 80000),
