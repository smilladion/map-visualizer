...
public enum Type {
    ...
    WETLAND("wetland", Color.CADETBLUE, true, 0, 18000),
    //GRASS("grass", Color.LAWNGREEN, true, 0, 18000),
    FARMLAND("farmland", Color.LIGHTGOLDENRODYELLOW, true, 0, 18000),
    ...
    HEATH("heath", Color.WHEAT, true, 0, 18000),
    MEADOW("meadow", Color.LIGHTGREEN, true, 0, 18000),
    QUARRY("quarry", Color.LIGHTGREY, true, 0, 18000),
    ...
    AERODROME("aerodrome", Color.LIGHTGREY, true, 0, 18000),
    APRON("apron", Color.GREY, true, 0, 18000),
    RUNWAY("runway", Color.DARKGREY, true, 2, 38000),
    BASIN("basin", Color.LIGHTBLUE, true, 0, 6000),
    RESERVOIR("reservoir", Color.LIGHTBLUE, true, 0, 6000),
    PARKING("parking", Color.LIGHTGREY, true, 0, 12000),
    VILLAGE_GREEN("village_green", Color.LIGHTGREEN, true, 0, 18000),
    SCRUB("scrub", Color.DARKOLIVEGREEN, true, 0, 18000),
    BEACH("beach", Color.YELLOW, true, 0, 18000),
    WATER("water", Color.LIGHTBLUE, true, 0, 6000),
    STREAM("stream", Color.LIGHTBLUE, false, 2, 6000),
    PIER("pier", Color.LIGHTGREY, false, 2, 18000),
    HIGHWAY("highway", Color.DIMGRAY, false, 1, 0),
    SEARCHRESULT("searchresult", Color.RED, false, 3, 0),
    BUILDING("building", Color.SADDLEBROWN, true, 0, 80000),
