...
public enum Type {
    ...
    // roads
    HIGHWAY("highway", "highway", Color.GAINSBORO, Color.BLACK, false, 1, 80000),
    ...
    TERTIARY("highway", "tertiary", Color.GAINSBORO, Color.BLACK, false, 4, 6000),
    TERTIARY_LINK("highway", "tertiary_link", Color.GAINSBORO, Color.BLACK, false, 3, 6000),
    UNCLASSIFIED("highway", "unclassified", Color.GAINSBORO, Color.BLACK, false, 3, 10000),
    RESIDENTIAL_ROAD("highway", "residential", Color.GAINSBORO, Color.BLACK, false, 2, 18000),
    LIVING_STREET("highway", "living_street", Color.GAINSBORO, Color.BLACK, false, 2, 30000),
    SERVICE("highway", "service", Color.GAINSBORO, Color.BLACK, false, 1, 80000),
    PEDESTRIAN("highway", "pedestrian", Color.GAINSBORO, Color.BLACK, false, 1, 80000),
    TRACK("highway", "track", Color.GAINSBORO, Color.BLACK, false, 1, 80000),
